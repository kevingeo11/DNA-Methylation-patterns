...
def filter_exp_files_HepG2(infile, outfile):
    chroms_seen = set()
    non_std_chroms = set()
    itr = 0
    chroms = ['chr' + str(i) for i in range(1,23)] + ['chrX', 'chrY']
...
if True:
    print('WGBS')
    WGBS_file = data_path + 'cpg.raw.sort.HCG.bed'
    filter_exp_files_HepG2(WGBS_file, WGBS_outfile)
...
if False:
    ...
    NOMe_file = data_path + 'cpg.raw.sort.GCH.bed'
    # filter_exp_files(NOMe_file, NOMe_outfile)
    filter_exp_files_HepG2(NOMe_file, NOMe_outfile)
    
'''
Promoter
'''    
if False:
    UCSC_file = main_path + 'Data/refSeq h19/' + '0-refGene_complete_hg19.csv.gz'
    outfile_UCSC_promo = outpath_processing + 'ref-promoter-h19.csv'
