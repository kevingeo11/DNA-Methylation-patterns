...
def plot_NOMe_WGBS_in_promoter(df_inter_promo_NOMe, dataset_name, plot_out):
    ...
    series = pd.Series(y)
    ywindows_10 = series.rolling(10).mean().tolist()
    plt.plot(x, ywindows_10, "-", color = "yellow")
    ywindows_100 = series.rolling(100).mean().tolist()
    plt.plot(x, ywindows_100, "-", color = "red")
...
outpath_processing = main_path + 'Data\\Promoter Extenstion Analysis\\pandas_server\\pandas\\'

# inter_out_promo_NOMe = inpath_processing + 'NOMe_intersect.csv'
# inter_out_promo_WGBS = inpath_processing + 'WGBS_intersect.csv'
inter_out_promo_NOMe = inpath_processing + 'NOMe_intersect_1m.csv'
inter_out_promo_WGBS = inpath_processing + 'WGBS_intersect_1m.csv'
...
outfile_pandas_NOMe = outpath_processing + 'pandas_promoter_NOMe_100k.csv'
outfile_pandas_WGBS = outpath_processing + 'pandas_promoter_WGBS_1m.csv'
...
if True:
    ...
    # plot_out = outpath_processing + 'NOMe_promoter_average_100-GpC_meth.pdf'
    plot_out = outpath_processing + 'NOMe_promoter_average_100k_rolling.png'
